...
\subfile{./txt/2-introduction.tex}

\subfile{./txt/3-existing-work.tex}

\subfile{./txt/4-theory.tex}

\subfile{./txt/5-Decoding-algorithms.tex}

\subfile{./txt/6-implementation.tex}

\subfile{./txt/7-results.tex}

\subfile{./txt/8-conclusion.tex}
